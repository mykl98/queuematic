...
<head>
    ...
    <title>Admin | System Reset</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">System Reset</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo $baseUrl;?>">Home</a></li>
                                <li class="breadcrumb-item active">System Reset</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col d-flex">
                        <div class="card shadow-sm flex-fill">
                            <div class="card-body">
                                <h5 class="card-title font-weight-bold text-danger mb-2">Queue Reset</h5>
                                <p class="card-text">This action will reset the Queue Database, Queue List Database and Queue Counter.</p>
                            </div>
                            <div class="card-footer">
                                <button type="button" class="btn btn-danger w-50 float-right" onclick="queueReset()">Reset</button>
                            </div>
                        </div>
                    </div>
                    <div class="col"></div>
